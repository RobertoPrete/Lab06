...
class Controller:
    ...
    def handleAnalizzaVendite(self, e):
        self._view.txt_result.controls.clear()
        # Fare il controllo nel caso in cui non vengono selezionati tutti i filtri
        # In questo caso mandare un alert per dire di selezionare tutti i filtri o deselezionarli tutti
